...
const caseOptions = [
  {
    ...
    data: {
      ...
      cn_condition: '灌溉较差', land_use: '林地', grades: 5, CN: 70.0,
      r: 5.5, r1: 5.8, r2: 6.3, rg: 10.0, c: 150,
      start_chainage: 1000, end_chainage: 2000,
      concrete_grade: 'C35', rebar_type: 'HRB400', Ag: 0.002,
      D_spacing: 30.0, beta2: 1.0, Pcrown_crit: 100.0, P_crit: 600.0,
  ...
  },
  {
    ...
    data: {
      ...
      r: 5.5, r1: 5.8, r2: 6.3, rg: 8.5, c: 80,
      start_chainage: 3000, end_chainage: 4500,
      concrete_grade: 'C35', rebar_type: 'HRB400', Ag: 0.0018,
      D_spacing: 25.0, beta2: 1.0, Pcrown_crit: 80.0, P_crit: 400.0,
      I_long: 0.02, double_side: true
    }
  }
];
...
const handleCaseChange = (val: string) => {
  ...
  if (targetCase && targetCase.data) {
    // 触发 store 全量覆写，瞬间完成 38/41 个参数的自动赋值
