...
在根目录 [[CHANGELOG.md|CHANGELOG]] 的顶部追加当前版本的更新日志块（**CI 门禁会自动提取此段落并注入至 GitHub Release 页面正文**）：
```markdown
## [1.1.0] - 2026-10-01
